      ...
      <main id="main-content">
        <div className="topbar">
          <span>
            ...
            {mock ? "Demo workspace" : "Analysis workspace"}
          </span>
          <span className="topbar-right">
            <span className="small">API v0.3</span>
        ...
        <header className="page-header" id="overview">
          <div>
            ...
            <p>Find a defensible cut. Understand the cost of being wrong.</p>
          </div>
          ...
          <>
            ...
            <div className="tile-grid">
              <section className="panel tile spending">
                ...
                <p className="small muted">A goal, not demonstrated savings.</p>
              </section>
              <section className="panel tile opportunity">
                ...
                {audit ? (
                  ...
                  <>
                    <strong className="metric empty-metric">Not modeled</strong>
                    <p className="muted">
              ...
              <section className="panel chart-panel">
                <div className="section-heading">
                  ...
                  <span className="badge">
                    {overview.provenance.synthetic ? "Synthetic" : "Observed"}
                  </span>
                </div>
                ...
                {presentation ? (
                  <>
                    ...
                    <p className="small">
                      ...
                      {usd(audit!.scenario.usd_per_gpu_hour)}/GPU-hour. Not a
                  ...
                  <>
                    <p>
                      The target is 20%. A verified contribution and matching
                      baseline are not yet available.
                    </p>
                    <p className="small">
                      Awaiting canonical target and gap values from the analysis
                      service.
                    </p>
                  </>
                )}
                ...
                {audit ? (
                  <>
                    <div className="evidence-stats">
                      <div>
                        <strong>{number(audit.eligibility.unique_jobs)}</strong>
                      ...
                      <div>
                        <strong>
                          {number(
                            audit.eligibility.overlapping_finding_references,
                          )}
                        </strong>
                    ...
                    <p className="small muted">
                      Eligibility is a measured rule match. Recoverability is
                      still an assumption.
                    </p>
