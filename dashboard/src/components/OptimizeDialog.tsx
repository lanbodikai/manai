...
export function OptimizeDialog({modelAvailable = true,rows,share,hours,jobs,overlap,sending,error,receipt,ready,review,restoreFocus,onDownload,onProceed,onReturn}:{
  ...
  return <dialog ref={dialog} className="optimize-dialog" aria-labelledby="optimize-dialog-title" aria-describedby="optimize-dialog-description" onKeyDown={e => {
    ...
    <div className="optimize-dialog-body">
      ...
      <details className="optimize-method"><summary>What is still needed for approval?</summary><ul><li>Engineering benchmarks and a named pilot owner.</li><li>Agreement on acceptable performance and rollback.</li><li>Actual billing evidence before calling released capacity cash savings.</li></ul><p>This request sends only selected action IDs for backend modeling. It does not authorize an infrastructure change.</p></details>
